...
public class LeftistHeapTest
{
    ...
    private LeftistHeap<Integer> testObject;

    @BeforeEach
    public void setUp()
    {
        testObject = new LeftistHeap<>(numbers);
    }

    @Test
    public void constructor_WhenFromLeftistHeap_ThenCopied()
    {
        // when
        var result = new LeftistHeap<>(testObject);
        // then
    ...
    {
        // when
        boolean result = new LeftistHeap<Integer>().isEmpty();
        // then
    ...
    {
        // when
        int result = new LeftistHeap<Integer>().size();
        // then
    ...
    {
        // when
        Iterator<Integer> result = new LeftistHeap<Integer>().iterator();
        // then
    ...
    public void iterator_WhenSingleElement_ThenThisElementOnly()
    {
        ...
        // when
        Iterator<Integer> result = new LeftistHeap<>(List.of(element)).iterator();
        // then
    ...
    {
        // when
        Integer result = new LeftistHeap<Integer>().peek();
        // then
    ...
    public void peek_WhenSingleElement_ThenThisElement()
    {
        ...
        int element = numbers.get(0);
        // when
        Integer result = new LeftistHeap<>(List.of(element)).peek();
        // then
    ...
    {
        // when
        Integer result = new LeftistHeap<Integer>().poll();
        // then
        Assertions.assertThat(result).isNull();
    }
    ...
    public void merge_WhenEmptyAndNotEmpty_ThenSameAsOther()
    {
        ...
        var other = new LeftistHeap<>(numbers);
        // when
    ...
    {
        // when
        testObject.merge(new LeftistHeap<>());
        // then
        Assertions.assertThat(testObject.size()).isEqualTo(numbers.size());
        Assertions.assertThat(testObject.peek()).isEqualTo(minimum);
    }
    ...
    {
        // given
        var other = new LeftistHeap<>(List.of(minimum + 5, minimum + 13, minimum + 20));
        // when
        testObject.merge(other);
        // then
        Assertions.assertThat(testObject.size()).isEqualTo(numbers.size() + other.size());
    ...
    public void merge_WhenMultipleMerges_ThenChangedOnlyMergingHeap()
    {
        ...
        testObject = new LeftistHeap<>();
        var first = new LeftistHeap<>(firstElements);
        var second = new LeftistHeap<>(secondElements);
        // when
