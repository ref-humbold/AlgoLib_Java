...
public class DirectedSimpleGraphTest
{
    ...
    public void getEdges()
    {
        ...
        Assertions.assertThat(result)
                  .containsExactlyInAnyOrder(ComparablePair.of(1, 5), ComparablePair.of(2, 4),
                                             ComparablePair.of(3, 6), ComparablePair.of(6, 3),
    ...
    public void getNeighbours()
    {
        ...
        // then
        Assertions.assertThat(result).containsExactlyInAnyOrder(1, 3, 4, 7, 9);
    }
    ...
    public void reverse()
    {
        ...
        Assertions.assertThat(result)
                  .containsExactlyInAnyOrder(ComparablePair.of(1, 9), ComparablePair.of(2, 1),
                                             ComparablePair.of(2, 6), ComparablePair.of(4, 5),
                                             ComparablePair.of(5, 3), ComparablePair.of(6, 6),
                                             ComparablePair.of(6, 9), ComparablePair.of(7, 5),
                                             ComparablePair.of(8, 7), ComparablePair.of(9, 4));
    }
}
